...
public abstract class CameraBridgeViewBase extends SurfaceView implements SurfaceHolder.Callback {
    ...
    /* Collin Stuff Start */ /* Source: https://heartbeat.fritz.ai/working-with-the-opencv-camera-for-android-rotating-orienting-and-scaling-c7006c3e1916 */
    ...
    private void updateMatrix() {
        ...
        if (orientation == Configuration.ORIENTATION_LANDSCAPE) { // In landscape
            ...
            mMatrix.preTranslate(-hw, -hh);
            mMatrix.preScale((float)(scale/16*9/2.8),(float) (scale/1.05),hw,hh);
        } else { // In portrait
//            mMatrix.preScale((float)(scale/16*9/1.2),(float)(scale/1.05),hw,hh);
            mMatrix.preScale((float)(scale/2),(float)(scale/2),hw,hh);
        }
